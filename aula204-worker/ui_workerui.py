...
class Ui_myWidget(object):
    ...
    def retranslateUi(self, myWidget):
        ...
        self.label2.setText(QCoreApplication.translate("myWidget", u"Text 2", None))
        self.label1.setText(QCoreApplication.translate("myWidget", u"Text 1", None))
        self.button1.setText(QCoreApplication.translate("myWidget", u"Button 1", None))
        self.button2.setText(QCoreApplication.translate("myWidget", u"Button 2", None))
    # retranslateUi
